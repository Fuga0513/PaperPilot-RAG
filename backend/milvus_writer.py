            ...
            insert_data = [
                {
                    ...
                    "paper_id": int(doc.get("paper_id", 0) or 0),
                    "paper_title": doc.get("paper_title", ""),
                    "section_title": doc.get("section_title", ""),
                    "subsection_title": doc.get("subsection_title", ""),
                    "page_start": int(doc.get("page_start", 0) or 0),
                    "page_end": int(doc.get("page_end", 0) or 0),
